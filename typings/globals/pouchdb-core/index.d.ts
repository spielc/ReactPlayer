...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/3f9b9ed351d9fc5c64576de74527ba923f5d6ed0/pouchdb-core/pouchdb-core.d.ts
declare namespace PouchDB {
    namespace Core {
        ...
        type ChangeEventType = 'change' | 'complete' | 'error';

        interface Options {
          ajax?: Configuration.RemoteRequesterConfiguration;
        }

        interface ChangesOptions<Content> {
            since: Since,
        ...
        type ChangesCallbackArg = (ChangeResponse | CompleteResponse | any);

        interface Changes extends Promise<Changes>{
            cancel(): void;
            results: any;
            on(type: ChangeEventType, callback: (args: ChangesCallbackArg) => void): Changes;
        }
    ...
    interface Database<Content extends Core.Encodable>  {
        ...
        changes(options: Core.ChangesOptions<Content>): Core.Changes;
        /*changes(options: Core.InfoOptions | void,
            callback: Core.Callback<any, Core.DatabaseInfo>): void;*/
    }
}
