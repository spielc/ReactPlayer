...
export function TrackComponent(props: TrackComponentProperties): JSX.Element {
    ...
    if (props.value != "actions")
        ...
        content = <div><i className="fa fa-play fa-lg" onClick={evt => props.state.play(props.trackIdx)}/> <i className="fa fa-bookmark-o fa-lg" onClick={evt => props.state.select(props.trackIdx)}/> <i className="fa fa-trash fa-lg" onClick={evt => props.state.removeTrack(props.trackIdx)}/></div>;
